        ...
        <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded" data-aos="fade-zoom-in" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600">
            <div>
                ...
                <p className="font-bold">
                    TOY-MONSTER: Unleashing Imagination and Fun since 2013
                    <h2 className="font-bold">Find Us: <span className="font-semibold">Road No 14, Rajshahi Court, Rajpara ,Rajshahi Bangladesh</span> </h2>
                </p>
